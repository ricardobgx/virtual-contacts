<template>
  <div class="edit-contact-form-field" v-bind:style="`border-color:` + color">
...
.edit-contact-form-field:nth-child(2) {
  margin-top: 0px;
}

.edit-contact-form-field input::placeholder {
  color: var(--secondary-color);
}

.edit-contact-form-field span {
  font-size: 25px;
  transition: all 0.2s linear;
}
